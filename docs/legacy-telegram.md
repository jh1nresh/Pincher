# Pincher — Legacy Telegram tooling

> Archived documentation for the original Consensus Telegram implementation. The current product README is [`README.md`](../README.md); this file is retained for historical reference and is not the campus pilot specification.
