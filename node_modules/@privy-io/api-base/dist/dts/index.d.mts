...
declare enum PrivyErrorCode {
    ...
    /** The user does not have any enrolled MFA methods but one is required. */
    MISSING_MFA_ENROLLMENT = "missing_mfa_enrollment",
    ...
    /** Conflict encountered while trying to update resource. */
    ...
    TRANSACTION_EXECUTION_FAILURE = "transaction_execution_failure",
    ...
    /** User sign ups are suspended for this account. */
...
declare class ResourceConflictError extends HttpError {
    constructor(message?: string);
}
declare class InsufficientBalanceError extends HttpError {
    constructor(message?: string);
}
declare class PaymentFailedError extends HttpError {
    constructor(message?: string);
}
...
export { APIError, AccountTransferRequiredError, AllowlistRejectedError, type ApiErrorType, ForbiddenError, HttpError, InsufficientBalanceError, InternalServerError, InvalidInputError, LegacyInvalidInputError, NotFoundError, PaymentFailedError, PrivyErrorCode, RequestTimeoutError, ResourceConflictError, TooManyRequestsError, UnauthorizedError, UnsupportedMediaType };
