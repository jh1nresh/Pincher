...
"[project]/Desktop/pincher/node_modules/@privy-io/react-auth/dist/esm/EmbeddedWalletConnectingScreen-9ADobSle.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "EmbeddedWalletConnectingScreen",
    ()=>d,
    "EmbeddedWalletConnectingView",
    ()=>p,
    "default",
    ()=>d
]);
...
;
;
const p = ({ connectionFailed: r, onClose: o })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$ScreenLayout$2d$CNho46nP$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["S"], r ? {
    ...
    component: ()=>{
        let { authenticated: t, user: m } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$get$2d$is$2d$unified$2d$wallet$2d$gMDXpX6C$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])(), { client: d, closePrivyModal: u, createAnalyticsEvent: y, walletProxy: v } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$internal$2d$context$2d$e$2d$Eni5bG$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])(), { navigate: h, data: f, setModalData: w, onUserCloseViaDialogOrKeybindRef: b } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$get$2d$is$2d$unified$2d$wallet$2d$gMDXpX6C$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(), j = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>Date.now(), []), [g, C] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(!1), { onCompleteNavigateTo: A, onFailure: I, shouldForceMFA: k, entropyId: x, entropyIdVerifier: S, recoveryMethod: F, connectingWalletAddress: M, isUnifiedWallet: P = !1 } = f?.connectWallet, T = (e)=>{
            g || (C(!0), I("string" == typeof e ? Error(e) : e));
        };
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
            let e;
            return t ? v ? ((async ()=>{
                let t = await d.getAccessToken();
                if (!t) return T("User must be authenticated and have a Privy wallet before it can be connected");
                try {
                    if (!P) {
                        if (!x || !S) return T("For on-device first-class chain wallets, entropyId and entropyIdVerifier are required");
                        await v.connect({
                            accessToken: t,
                            entropyId: x,
                            entropyIdVerifier: S
                    ...
                    let r = (Date.now() - j) / 1e3;
                    "EmbeddedWalletKeyExportScreen" === A && r < 1 ? e = setTimeout(()=>{
                        h(A, !1);
                    }, 1e3 * (1 - r)) : h(A, !1);
                } catch (e) {
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$index$2d$NL2cPmJD$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(e) && "privy" === F) {
                        let e = await d.getAccessToken();
                        if (!e) return T("User must be authenticated and have a Privy wallet before it can be recovered");
                        try {
                            y({
                            ...
                            let t = await v?.recover({
                                accessToken: e,
                                entropyId: x,
                                entropyIdVerifier: S
                            });
                            t?.entropyId || T(Error("Unable to recover wallet")), A ? h(A) : u({
                    ...
                    } else (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$index$2d$NL2cPmJD$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(e) && "privy" !== F && "privy-v2" !== F ? (w({
                        ...f,
                        recoverWallet: {
                            entropyId: x,
                            entropyIdVerifier: S,
                            onCompleteNavigateTo: A,
                            onFailure: I
                        },
                        recoveryOAuthStatus: {
                            provider: F,
                    ...
                    }), h((0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$index$2d$NL2cPmJD$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(F))) : T(e);
                }
            })(), ()=>clearTimeout(e)) : void 0 : T("User must be authenticated and have a Privy wallet before it can be connected");
        }, [
            t,
            m,
            v
        ]), b.current = ()=>{
            T("User exited before wallet could be connected"), u({
                shouldCallAuthOnSuccess: !1
            });
        }, /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(p, {
            connectionFailed: g,
...
//# sourceMappingURL=cb648_9f4b4728._.js.map