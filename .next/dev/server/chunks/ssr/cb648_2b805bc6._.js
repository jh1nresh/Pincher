...
"[project]/Desktop/pincher/node_modules/@privy-io/react-auth/dist/esm/CoinbaseOnrampStatusScreen-BNmvm8Bl.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "CoinbaseOnrampStatusScreen",
    ()=>w,
    "default",
    ()=>w
]);
...
const w = {
    component: ()=>{
        let { data: o, setModalData: i, navigate: c, navigateBack: m } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$get$2d$is$2d$unified$2d$wallet$2d$gMDXpX6C$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(), { closePrivyModal: l, createAnalyticsEvent: d, client: p } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$internal$2d$context$2d$e$2d$Eni5bG$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])(), [u, b] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("pending-in-flow"), w = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0), C = {
            ...o?.funding,
            showAlternateFundingMethod: !0
        };
        C.usingDefaultFundingMethod && (C.usingDefaultFundingMethod = !1);
        let { partnerUserId: I, popup: k } = o?.coinbaseOnrampStatus ?? {};
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
            if ("pending-in-flow" === u || "pending-after-flow" === u) {
                let e = setInterval(async ()=>{
                    if (I) try {
                        let { status: e } = await p.getCoinbaseOnRampStatus({
                            partnerUserId: I
                        });
                        if ("success" === e) return void b("success");
                        if ("failure" === e) throw Error("There was an error completing Coinbase Onramp flow.");
                        if (w.current >= 3) return i({
                            funding: C,
                            solanaFundingData: o?.solanaFundingData
                        }), void c("FundingMethodSelectionScreen");
                        k?.closed && (w.current = w.current + 1, b("pending-after-flow"));
                    } catch (e) {
                        console.error(e), b("error"), d({
                            ...
                            solanaFundingData: o?.solanaFundingData
                        }), c("FundingMethodSelectionScreen");
                    }
                }, 1500);
...
let j = ({ status: o, onClickCta: i })=>{
    let { title: n, body: a, cta: s } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>((e)=>{
            switch(e){
                case "success":
                    return {
    ...
    if (!r) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxs"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$index$2d$NL2cPmJD$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["G"], {
                    style: {
                        position: "absolute",
                        width: "2.8rem",
                        height: "2.8rem",
    ...
    let n = r ? __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$solid$2f$esm$2f$CheckCircleIcon$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"] : ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$solid$2f$esm$2f$ArrowsRightLeftIcon$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
        ...
        }), a = r ? "var(--privy-color-success)" : "var(--privy-color-foreground-4)"; /*#__PURE__*/ 
...
}, I = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pincher$2f$node_modules$2f$styled$2d$components$2f$dist$2f$styled$2d$components$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["styled"].p.withConfig({
    displayName: "StatusBody",
    componentId: "sc-e4350fdc-0"
})([
...
//# sourceMappingURL=cb648_2b805bc6._.js.map